...
<template>
  ...
  <button v-if="$props.function" @click="$props.function.bind($event)" type="button" class="has-tooltip-arrow" data-tooltip="Sort"><span class="material-icons text-sm">swap_vert</span></button>
